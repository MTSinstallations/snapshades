      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <Card className="w-full max-w-md">
          <CardContent className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-gray-500 mt-1">
                {mode === 'signin'
                  ...
                  : 'Start your window transformation journey'}
              </p>
            </div>
            ...
            <Button
              variant="outline"
              className="w-full rounded-xl py-5 gap-3 mb-6"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  minLength={6}
                  className="w-full pl-10 pr-12 py-3 rounded-xl border border-gray-200 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none text-sm"
                />
                <button
                  type="button"
              ...
              <Button
                type="submit"
                disabled={submitting}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-xl py-5 text-sm font-semibold gap-2"
              >
